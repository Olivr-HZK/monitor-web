...
def _load_ai_config(config_data: Dict) -> Dict:
    ...
    fallback_config = ai_config.get("fallback", {}) or {}
    fallback_model = _get_env_str("AI_FALLBACK_MODEL") or fallback_config.get("model", "")
    fallback_api_key = _get_env_str("AI_FALLBACK_API_KEY") or fallback_config.get("api_key", "")
    fallback_api_base = _get_env_str("AI_FALLBACK_API_BASE") or fallback_config.get("api_base", "")
